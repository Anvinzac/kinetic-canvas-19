...
/**
 * @responsibility Describe a seamless tiling pattern backdrop theme for canvas posts.
 * @pure true
 */
...
/**
 * @responsibility Compute CSS `background-position` for a pattern theme at a page index.
 * @inputs Pattern theme + page shift index
 * @outputs CSS background-position string (single or per-layer offsets)
 * @pure true
 */
