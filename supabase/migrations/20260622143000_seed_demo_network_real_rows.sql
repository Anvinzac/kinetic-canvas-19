...
WITH seed_posts (
  ...
  VALUES
    ...
    (
      ...
      'float',
      'linear-gradient(135deg,#00B4D8,#FF006E)',
      ARRAY['https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?auto=format&fit=crop&w=1400&q=80']::text[],
      NULL,
    ...
    (
      ...
      ARRAY['https://images.unsplash.com/photo-1449824913935-59a10b8d2000?auto=format&fit=crop&w=1400&q=80']::text[],
      NULL,
    ...
    (
      ...
      ARRAY['https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExdjlvNjVwMWYxeHQ2aGloY2N4czJqeDZvY2Rwd21ubWF5eHhhbjhhOSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/tZZTCbdO5cRUVUULFL/giphy.gif']::text[],
      NULL,
    ...
    (
      ...
      ARRAY['https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1400&q=80']::text[],
      NULL,
    ...
    (
      ...
      ARRAY['https://images.unsplash.com/photo-1501785888041-af3ef285b470?auto=format&fit=crop&w=1400&q=80']::text[],
      NULL,
    ...
    (
      ...
      ARRAY['https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=1400&q=80']::text[],
      NULL,
